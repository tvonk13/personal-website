...
export default function PersonalWebsite() {
    return (
        <ProjectPage
            ...
            successes={{
                text: [
                    "The two biggest successes of this project were getting rewarding experience in front end design and development as well as creating a personal website that I am proud of and that I feel conveys my personality well. When I started, I had no idea that I was going to enjoy the process so much and now I am grateful that I did because it has launched my self-driven journey into figuring out a passion that caters to both my software engineering and creative design interests."
                ]
            }}
        />
    )
